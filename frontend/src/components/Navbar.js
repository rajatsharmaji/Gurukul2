        ...
        <>
          <nav>
           ...
           <div>
            ...
            <li><a className={window.location.pathname === "/home" ? "active" : ""}
             href="/home">Gurukul</a></li>
            <li><a className={window.location.pathname === "/questions" ? "active" : ""} href="/questions">Questions</a></li>
            <li><a className={window.location.pathname === "#alumni" ? "active" : ""} href="#alumni">Avsar</a></li>
            <li><a className={window.location.pathname === "/#contact" ? "active" : ""} href="#contact">Contact-us</a></li>
           {
            sessionStorage.getItem("success")=== "true" ?
            <li><a id="button" onClick={() => logoutClick()}>
            Logout</a></li>:
              <li><a className={((window.location.pathname === "/login") || (window.location.pathname === "/register"))? "active" : ""}>Hello Coder</a> </li>
           }
            </ul>
           </div>
           ...
           <div id="mobile" onClick={()=>handleClick()}>
             <i
             id="bar" className={clicked ? "fas fa-times" : "fas fa-bars"}
             ></i>
           </div>
